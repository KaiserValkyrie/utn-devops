...
Vagrant.configure("2") do |config|
  ...
  #Se redireciona el puerto 8080 de la pc fisica en el 80 de la de virtual
  ...
  #se linkea el directorio donde se encuentra el archivo vagrantfile en 
  #la maquina virtual dentro del directorio vagrant
